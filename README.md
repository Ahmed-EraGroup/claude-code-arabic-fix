...
أو من سطر الأوامر:
```
code --install-extension claude-code-arabic-fix-1.2.1.vsix
```
...
يشغّل 43 اختبارًا: سلوك الإضافة نفسها (ترقيع، إعدادات، إزالة، تعدد إصدارات Claude Code، حالات الفشل) عبر مجلد إضافات وهمي و`vscode` مُحاكى، بالإضافة إلى تشغيل الكود المحقون داخل DOM حقيقي (jsdom) للتحقق من قرارات الاتجاه على markup مشابه للوحة المحادثة.
